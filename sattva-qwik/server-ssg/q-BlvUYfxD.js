...
const _renderSSR = async (node, opts) => {
  ...
  containerAttributes["q:container"] = "paused", containerAttributes["q:version"] = "1.19.2", containerAttributes["q:render"] = (qRender ? qRender + "-" : "") + "ssr", containerAttributes["q:base"] = opts.base || "", containerAttributes["q:locale"] = locale, containerAttributes["q:manifest-hash"] = opts.manifestHash, containerAttributes["q:instance"] = hash();
...
const spaInit = eventQrl(/* @__PURE__ */ _noopQrl("s_5d7t5JikPRg"));
const s_2js3p00sr5w = () => {
...
const RouterOutlet = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl(s_2js3p00sr5w, "s_2js3p00sr5w"));
...
const loadClientData = async (url, element, opts) => {
  ...
  let resolveFn;
  if (!qData) {
    const fetchOptions = getFetchOptions(opts == null ? void 0 : opts.action, opts == null ? void 0 : opts.clearCache);
...
const s_X0OZwAHeceo = `:root{view-transition-name:none}`;
const s_RLkKhQAYoBs = (fn$) => {
  return;
};
const s_QsYluHyVG64 = async (path, opt) => {
...
const s_y00FB8HXjIk = (props) => {
  useStylesQrl(/* @__PURE__ */ inlinedQrl(s_X0OZwAHeceo, "s_X0OZwAHeceo"));
  ...
  const registerPreventNav = /* @__PURE__ */ inlinedQrl(s_RLkKhQAYoBs, "s_RLkKhQAYoBs");
  const goto = /* @__PURE__ */ inlinedQrl(s_QsYluHyVG64, "s_QsYluHyVG64", [
    actionState,
    navResolver,
    routeInternal,
    routeLocation
  ...
  useTaskQrl(/* @__PURE__ */ inlinedQrl(s_xSxVQiMPszI, "s_xSxVQiMPszI", [
    actionState,
    content,
    contentInternal,
    documentHead,
  ...
  return /* @__PURE__ */ _jsxC(Slot, null, 3, "d1_3");
};
const QwikCityProvider = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl(s_y00FB8HXjIk, "s_y00FB8HXjIk"));
const s_Z1TPBMQrIPs = (_, elm) => {
  var _a2;
...
const s_VA3aU09ZNZ4 = async (event, elm) => {
...
const s_3N7flsM1ac4 = (_, elm) => {
  const url = new URL(elm.href);
  preloadRouteBundles(url.pathname, 1);
};
const s_djotTTR6Vgk = (props) => {
  ...
  const handlePrefetch = prefetch ? /* @__PURE__ */ inlinedQrl(s_Z1TPBMQrIPs, "s_Z1TPBMQrIPs") : void 0;
  ...
  const handleClientSideNavigation = clientNavPath ? /* @__PURE__ */ inlinedQrl(s_VA3aU09ZNZ4, "s_VA3aU09ZNZ4", [
    nav,
    reload,
    replaceState,
    scroll
  ]) : void 0;
  const handlePreload = /* @__PURE__ */ inlinedQrl(s_3N7flsM1ac4, "s_3N7flsM1ac4");
  useVisibleTaskQrl(/* @__PURE__ */ _noopQrl("s_D6dphgp2ONQ", [
    anchorRef,
    handlePrefetch,
    linkProps,
    loc
  ...
  return /* @__PURE__ */ _jsxS("a", {
    ...
    children: /* @__PURE__ */ _jsxC(Slot, null, 3, "d1_5"),
    onClick$: [
      preventDefault,
      handlePreload,
      onClick$,
...
const Link = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl(s_djotTTR6Vgk, "s_djotTTR6Vgk"));
...
export {
  ...
  componentQrl as a,
  useLocation as b,
  createContextId as c,
  useStore as d,
  useContextProvider as e,
  useVisibleTaskQrl as f,
  _noopQrl as g,
  _fnSignal as h,
  inlinedQrl as i,
  _wrapSignal as j,
  _jsxC as k,
  useLexicalScope as l,
  _IMMUTABLE as m,
  _jsxBranch as n,
  useContext as o,
  _wrapProp as p,
  ...
  setPlatform as t,
  useSignal as u,
  _pauseFromContexts as v,
  getPlatform as w,
  useDocumentHead as x,
  _jsxS as y,
  ServiceWorkerRegister as z
};
